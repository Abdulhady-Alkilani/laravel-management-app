...
{
    protected static string $relationship = 'reports'; // اسم العلاقة في Workshop model
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('project_id')
                    ...
                    ->searchable()
                    ->preload()
                    ->nullable() // هذا يجب أن يكون مطابقاً لـ Migration
                    ->label('المشروع'),
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('project.name')->label('المشروع')->searchable()->sortable(),
