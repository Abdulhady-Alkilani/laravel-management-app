...
use App\Filament\Worker\Resources\Worker\CvResource\Pages;
use App\Filament\Worker\Resources\Worker\CvResource\RelationManagers;
use App\Models\Cv;
use Filament\Forms;
...
class CvResource extends Resource
{
    ...
    public static function getPages(): array
    {
       ...
       //     'view' => Pages\ViewCv::route('/{record}'), // <== صفحة العرض
        ];
    }

    // <== إذا كنت تريد السماح بإنشاء CV إذا لم يكن لديه، اترك هذه الدالة
    // لكن المتطلب هو "عرض وتعديل" فقط، لذا لن نحتاج لـ canCreate() هنا
    // public static function canCreate(): bool
    // {
    //     return auth()->user() && !auth()->user()->cvs()->exists();
    // }
}