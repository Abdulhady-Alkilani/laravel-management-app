@php
    ...
    // $user و $allSkills يجب أن يتم تمريرهما من الـ View الرئيسي
    if (!isset($user) || !isset($allSkills)) {
        // رسالة خطأ أو توجيه إذا لم يتم تمرير المتغيرات المطلوبة
        echo '<div class="alert alert-danger">خطأ: المتغيرات المطلوبة لنموذج السيرة الذاتية غير متوفرة.</div>';
        return;
    }
@endphp
