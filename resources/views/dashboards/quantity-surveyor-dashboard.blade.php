<x-layouts.app-layout title="لوحة تحكم مهندس الكميات / التكاليف">
    <div class="dashboard-card">
        <h2 class="text-primary mb-4">لوحة تحكم مهندس الكميات / التكاليف</h2>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="dashboard-content-tab-pane" role="tabpanel" aria-labelledby="dashboard-content-tab" tabindex="0">
                <h3 class="mb-3">مرحبًا بك في لوحة تحكم مهندس الكميات / التكاليف!</h3>
                <p>هنا يمكنك إدارة تقدير التكاليف، وحساب الكميات، ومراقبة الميزانية للمشاريع.</p>
                <ul>
                    <li>إعداد جداول الكميات والمواصفات.</li>
                    <li>تقدير التكاليف الأولية والتفصيلية للمشاريع.</li>
                    <li>مراقبة المصروفات وإعداد تقارير الميزانية.</li>
                </ul>
            </div>
