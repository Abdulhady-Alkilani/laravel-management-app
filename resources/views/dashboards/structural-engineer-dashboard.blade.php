<x-layouts.app-layout title="لوحة تحكم المهندس الإنشائي">
    <div class="dashboard-card">
        <h2 class="text-primary mb-4">لوحة تحكم المهندس الإنشائي</h2>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="dashboard-content-tab-pane" role="tabpanel" aria-labelledby="dashboard-content-tab" tabindex="0">
                <h3 class="mb-3">مرحبًا بك في لوحة تحكم المهندس الإنشائي!</h3>
                <p>هنا يمكنك إدارة مهام التصميم والتحليل الإنشائي للمشاريع.</p>
                <ul>
                    <li>مراجعة المخططات الإنشائية.</li>
                    <li>حساب الأحمال وتصميم العناصر الإنشائية.</li>
                    <li>متابعة تنفيذ الهياكل الخرسانية والفولاذية.</li>
                </ul>
            </div>
