<x-layouts.app-layout title="لوحة التحكم العامة">
    <div class="dashboard-card">
        <h2 class="text-primary mb-4">لوحة التحكم العامة</h2>
        ...
        <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
            ...
            {{-- تبويبة تقديم السيرة الذاتية لا تظهر هنا افتراضيًا، لكن يمكن إضافتها بشرط --}}
            @php
                $user = Auth::user();
                $engineerRoles = [
        ...
        <div class="tab-content" id="myTabContent">
            ...
            {{-- تبويبة المحتوى الرئيسي للداشبورد --}}
            <div class="tab-pane fade" id="dashboard-content-tab-pane" role="tabpanel" aria-labelledby="dashboard-content-tab" tabindex="0">
                <h3 class="mb-3">مرحبًا بك، {{ $user->first_name }}!</h3>
                <p>هذه هي لوحة التحكم الافتراضية الخاصة بك.</p>
                {{-- محتوى عام إضافي هنا --}}
            </div>

            {{-- تبويبة تقديم السيرة الذاتية (للمهندسين الذين ليس لديهم CV) --}}
            @if($isEngineer && !$hasCv)
                    ...
                    <fieldset class="mb-4 p-3 border rounded">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="selected_skills" name="selected_skills[]" multiple>
                                ...
                                @php $allSkills = \App\Models\Skill::orderBy('name')->get(); @endphp
