<x-layouts.app-layout title="لوحة تحكم المهندس الجيوتقني">
    <div class="dashboard-card">
        <h2 class="text-primary mb-4">لوحة تحكم المهندس الجيوتقني</h2>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="dashboard-content-tab-pane" role="tabpanel" aria-labelledby="dashboard-content-tab" tabindex="0">
                <h3 class="mb-3">مرحبًا بك في لوحة تحكم المهندس الجيوتقني!</h3>
                <p>هنا يمكنك إدارة دراسات التربة والأساسات للمشاريع.</p>
                <ul>
                    <li>تحليل وتقييم خواص التربة والصخور.</li>
                    <li>تقديم التوصيات لتصميم الأساسات المناسبة.</li>
                    <li>متابعة أعمال الحفر وتثبيت التربة في الموقع.</li>
                </ul>
            </div>
