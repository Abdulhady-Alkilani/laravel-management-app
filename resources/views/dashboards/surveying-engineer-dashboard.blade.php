<x-layouts.app-layout title="لوحة تحكم مهندس المساحة">
    <div class="dashboard-card">
        <h2 class="text-primary mb-4">لوحة تحكم مهندس المساحة</h2>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="dashboard-content-tab-pane" role="tabpanel" aria-labelledby="dashboard-content-tab" tabindex="0">
                <h3 class="mb-3">مرحبًا بك في لوحة تحكم مهندس المساحة!</h3>
                <p>هنا يمكنك إدارة أعمال الرفع المساحي، وتحديد المواقع، ورسم الخرائط للمشاريع.</p>
                <ul>
                    <li>إجراء المسوحات الطبوغرافية للمواقع.</li>
                    <li>تحديد نقاط المرجع ومحاور البناء.</li>
                    <li>إعداد الخرائط المساحية وتحديثها.</li>
                </ul>
            </div>
