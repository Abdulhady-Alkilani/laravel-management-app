<x-layouts.app-layout title="لوحة تحكم المدير">
    <div class="dashboard-card">
        @php
            ...
            $allSkills = \App\Models\Skill::orderBy('name')->get(); // جلب المهارات هنا
        @endphp

        <h2 class="text-primary mb-4">لوحة تحكم المدير</h2>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="dashboard-content-tab-pane" role="tabpanel" aria-labelledby="dashboard-content-tab" tabindex="0">
                <h3 class="mb-3">مرحبًا بك، أيها المدير!</h3>
                <p>هنا يمكنك إدارة المشاريع، المهام، والورشات التابعة لك.</p>
                {{-- محتوى خاص بالمدير هنا --}}
            </div>
