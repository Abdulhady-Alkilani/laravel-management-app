<x-layouts.app-layout title="لوحة تحكم المهندس الكهربائي">
    <div class="dashboard-card">
        <h2 class="text-primary mb-4">لوحة تحكم المهندس الكهربائي</h2>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="dashboard-content-tab-pane" role="tabpanel" aria-labelledby="dashboard-content-tab" tabindex="0">
                <h3 class="mb-3">مرحبًا بك في لوحة تحكم المهندس الكهربائي!</h3>
                <p>هنا يمكنك إدارة وتتبع أنظمة وتمديدات الكهرباء في المشاريع.</p>
                <ul>
                    <li>تصميم شبكات الكهرباء وأنظمة الإضاءة.</li>
                    <li>الإشراف على تركيب التمديدات الكهربائية.</li>
                    <li>فحص أنظمة الطاقة والتأكد من فعاليتها.</li>
                </ul>
            </div>
