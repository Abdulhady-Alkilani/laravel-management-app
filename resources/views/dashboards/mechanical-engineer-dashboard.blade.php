<x-layouts.app-layout title="لوحة تحكم المهندس الميكانيكي">
    <div class="dashboard-card">
        <h2 class="text-primary mb-4">لوحة تحكم المهندس الميكانيكي</h2>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="dashboard-content-tab-pane" role="tabpanel" aria-labelledby="dashboard-content-tab" tabindex="0">
                <h3 class="mb-3">مرحبًا بك في لوحة تحكم المهندس الميكانيكي!</h3>
                <p>هنا يمكنك الإشراف على أنظمة التدفئة والتكييف والسباكة في المشاريع.</p>
                <ul>
                    <li>تصميم أنظمة HVAC (التدفئة والتهوية وتكييف الهواء).</li>
                    <li>الإشراف على تركيب شبكات السباكة وأنظمة مكافحة الحرائق.</li>
                    <li>ضمان كفاءة الأنظمة الميكانيكية وجودة التركيب.</li>
                </ul>
            </div>
