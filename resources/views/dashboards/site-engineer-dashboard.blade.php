<x-layouts.app-layout title="لوحة تحكم مهندس الموقع">
    <div class="dashboard-card">
        <h2 class="text-primary mb-4">لوحة تحكم مهندس الموقع</h2>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="dashboard-content-tab-pane" role="tabpanel" aria-labelledby="dashboard-content-tab" tabindex="0">
                <h3 class="mb-3">مرحبًا بك في لوحة تحكم مهندس الموقع!</h3>
                <p>هنا يمكنك الإشراف المباشر على عمليات البناء اليومية في المواقع.</p>
                <ul>
                    <li>الإشراف على العمال والورشات في الموقع.</li>
                    <li>التأكد من مطابقة الأعمال للمخططات والمواصفات.</li>
                    <li>حل المشكلات الفنية الطارئة في الموقع.</li>
                </ul>
            </div>
